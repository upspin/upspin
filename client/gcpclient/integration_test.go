// This is an integration test for gcpclient. It requires you setup a
// local GCP Directory instance running on port 8081. The use 'go test -tas integration'.
//
...
func testMkdir(context *upspin.Context, t *testing.T) {
	...
	// Look inside the dir entry to make sure it got created okay.
...
func TestRunAllTests(t *testing.T) {
	for _, packing := range []upspin.Packing{upspin.UnsafePack, upspin.PlainPack, upspin.DebugPack} {
