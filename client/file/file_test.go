...
func (d *dummyClient) PutLink(name upspin.PathName, data []byte) (*upspin.DirEntry, error) {
	return nil, nil
}
func (d *dummyClient) PutCopyingReferences(oldName, newName upspin.PathName) (*upspin.DirEntry, error) {
	return nil, nil
}
