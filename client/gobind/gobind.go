// Package gobind provides go bindings for other languages to use.
// It simplifies the upspin Client and its data structures in a way
// that languages such as Java can handle and gomobile can export.
package gobind
