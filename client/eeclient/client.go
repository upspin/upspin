...
type Client struct {
	...
	packing   upspin.Packing   // select which Client;  for now, assume End2End
...
// Signature and WrappedKeys are saved in upspin.Metadata when Location.Reference.Packing == End2End
