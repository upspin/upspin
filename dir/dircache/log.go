...
const (
	...
	// we have already applyied or overridden.
	SequenceLRUMax = 2000
)
...
// updateSequenceLRU sets the event sequence for name to seq
// if seq is more recent that the current sequence. It will return
// true only if the sequence has been updated.
func (l *clog) updateSequenceLRU(name upspin.PathName, seq int64) bool {
