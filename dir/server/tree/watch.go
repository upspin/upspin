...
// given offset 'from' until it reaches the end of the log. It returns the next
// offset to read.
...
// processed. TODO: send the logEntry directly? Possible, but requires we
// synchronize with the goroutine sending previous log entries (see todo at the
// top of this file).
