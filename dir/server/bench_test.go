...
func BenchmarkWhichAccessNoCacheRoot(b *testing.B) { benchmarkWhichAccess(b, !cached, userName, 0) }
func BenchmarkWhichAccessCacheRoot(b *testing.B)   { benchmarkWhichAccess(b, cached, userName, 0) }
