...
type DirServer interface {
	...
	// when, for example, an entry is put into another tree under a
	// different name. One should always validate the entry by verifying the
	// signature based on its SignedName.
	//
