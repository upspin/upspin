...
// full name) with the contents of the Link field of the returned
// DirEntry.
var ErrFollowLink = errors.Str("action not complete: must follow link")
...
type DirServer interface {
	...
	// updating the pattern as appropriate.
...
const (
	...
	// AttrLink identifies a link. It must be the only attribute. TODO: Can we have Link|Directory now?
