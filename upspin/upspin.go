...
type Packer interface {
	...
	// Share, executed by the file owner, extracts the per-file symmetric
	// encryption key from packdata, wraps for readers, and updates packdata.
	// In case of error, Share skips the wrapping for that reader or packdata.
