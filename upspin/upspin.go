...
// be only one per process (named TPC) and installation of the AccessMethod will happen in
// the AccessMethod's Init().
//
// Example, directory lookup:
//
// am,_ := TPC.Bind(myContext, location)
// dirEnt,_ := am.Lookup("/the/rain/in/spain")
//
