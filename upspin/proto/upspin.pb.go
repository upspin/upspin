...
type DirClient interface {
	...
	PutDir(ctx context.Context, in *DirPutRequest, opts ...grpc.CallOption) (*EntryError, error)
...
func (c *dirClient) PutDir(ctx context.Context, in *DirPutRequest, opts ...grpc.CallOption) (*EntryError, error) {
	out := new(EntryError)
	err := grpc.Invoke(ctx, "/proto.Dir/PutDir", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DirServer interface {
	...
	PutDir(context.Context, *DirPutRequest) (*EntryError, error)
...
func _Dir_PutDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DirPutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DirServer).PutDir(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Dir/PutDir",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DirServer).PutDir(ctx, req.(*DirPutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
