...
//
// It should be called only by client programs,
// directly after parsing a context.
// This handles the case where a context specifiesan inprocess directory
// server and configures that server to talk to the specified store server.
