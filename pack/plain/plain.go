...
func (plainPack) Pack(ciphertext, cleartext []byte, meta *upspin.Metadata, name upspin.PathName) (int, error) {
...
func (plainPack) UnpackLen(ciphertext []byte, meta *upspin.Metadata) int {
