...
// packBlob is a helper function that packs text according to the parameters and returns the cipher.
...
// unpackBlob is a helper function that unpacks cipher according to the parameters and returns the plain text.
...
func TestLoadingRemoteKeys(t *testing.T) {
	...
	ctx.PrivateKey = dudesPrivKey // This is necessary to prevent reading keys from .ssh/
	ctx.User = mockUser
