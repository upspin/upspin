...
var (
	...
	logLevel      = flag.String("loglevel", "info", "sets the log level to one of {debug, info, error, disabled}'")
...
func CurrentLevel() Level {
	l := logLevelFromString(*logLevel)
	if l == Linvalid {
		Error.Printf("Invalid log level %q", *logLevel)
		return Linfo
	}
	return l
}
