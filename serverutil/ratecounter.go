...
// added per unit of time, averaged over a certain number of samples. For
...
func newRateCounter(samples int, d time.Duration, tick <-chan time.Time) (*RateCounter, error) {
	if samples < 1 {
