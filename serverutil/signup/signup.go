...
const (
	...
	// defaultFromAddress is the default origin address for signup notification messages.
	defaultFromAddress = "noreply@upspin.io"
...
type MailConfig struct {
	...
	// Notify holds the email address that notifications should be sent to. If empty,
	// notifications are not sent.
	Notify string

	// From holds the address to send the email notifications from.
	From string
}
