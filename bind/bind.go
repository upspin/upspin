...
// ReregisterUser re-registers a User interface for the transport.
...
// ReregisterDirectory re-registers a Directory interface for the transport.
...
// ReregisterStore re-registers a Store interface for the transport.
