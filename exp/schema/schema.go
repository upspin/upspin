...
/*
Package schema provides a mechanism to declare and create a set of Upspin users
and servers.
...
*/
package schema // import "upspin.io/exp/schema"
...
// FromFile parses a Schema from the named file.
// If no name is provided the DefaultSchema is used.
func FromFile(name string, basePort int) (*Schema, error) {
	var data []byte
	if name == "" {
