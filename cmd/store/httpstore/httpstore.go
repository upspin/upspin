// Package main implements httpstore server, a Store service that speaks HTTP REST transport.
package main
...
// putHandler handles file put requests, for storing new references.
...
// getHandler handles get requests for retrieving references.
...
// deleteHandler handles delete requests for deleting references.
