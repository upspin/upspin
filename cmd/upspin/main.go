...
owned by the user. It is intended to be run after a user has stored
new keys in the key server.
`
...
func (s *State) rotate(args ...string) {
	const help = `
Rotate TODO I don't know what this does, exactly and how it relates
to countersign.
`
