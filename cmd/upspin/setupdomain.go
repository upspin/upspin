...
If you intend to deploy to a Google Cloud Platform project you must be specify
the project ID with -project. This permits later steps to find the generated
