...
func (s *server) home(w http.ResponseWriter, r *http.Request) {
	s.info(w, "Hello dudes! This is a superlong message a superlong message a superlong message a superlong message a superlong message a superlong message that will be split depending on how we resize our browser window bla bla bla", "Quit", "/exit")
}
