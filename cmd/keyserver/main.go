...
// Keyserver is a wrapper for a key implementation that presents it as a GRPC
// interface.
package main
...
func main() {
	...
	authConfig := grpcauth.ServerConfig{
	...
	authServer := grpcauth.NewServer(ctx, &authConfig)
