...
// BufferResponse reads the body of an HTTP response up to maxBufLen bytes. It closes the request. If the response is
// larger than maxBufLen, it returns ErrTooLong.
