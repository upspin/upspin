...
// NewPath returns the file path to hold the contents of the blob
// with the specified reference. The returned path is rooted
// in the provided base directory.
// The method used here will replace the old Path function once
// a conversion tool is in place, as Path has several problems.
func NewPath(base, ref string) string {
