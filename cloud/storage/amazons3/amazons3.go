...
// These constants define ACLs for writing data to Amazon Simple Storage Service.
// Definitions according to http://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl
const (
	// ACLPublicRead means owner gets FULL_CONTROL. The AllUsers group gets READ access.
	ACLPublicRead = "public-read"
	// ACLPrivate means owner gets FULL_CONTROL. No one else has access rights (default).
	ACLPrivate = "private"
)
