...
func TestSend(t *testing.T) {
	...
	const (
		...
		textBody  = "text"
		htmlBody  = "html"
		goldenReq = `{"Personalizations":[{"To":[{"Email":"somewhere@near.japan","Name":""}],"Subject":"hello"}],"From":{"Email":"me@example.com","Name":""},"Content":[{"Type":"text/plain","Value":"text"},{"Type":"text/html","Value":"html"}]}`
	)
	sg := New(key)
