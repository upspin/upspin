...
//
// It registers the -https_addr, -https_cert_file, and -https_cert_key_file
// flags with the flag package, for use when the server is run outside of GCE.
package https
...
// the address specified by the -https_addr flag using the certificate and key
// files specified by the -https_cert_file and -https_cert_key_file flags.
