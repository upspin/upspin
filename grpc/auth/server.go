...
type Service interface {
	// Service returns the name of the service, which forms the first path
	// component of any HTTP request.
	Service() string

	// RequestMessage returns a proto message for the given request method.
	RequestMessage(method string) pb.Message

	// Dispatch executes the given request for the specified user.
