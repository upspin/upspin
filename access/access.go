...
const (
	invalidFormat = "%d: unrecognized text: %q"
)
...
func toLower(b byte) byte {
	// This is an old trick that works because space is char 32 and 'a' and 'A' are separated by 32 characters in the ASCII table
	return b | ' '
}
