...
func (a *Access) MarshalJSON() ([]byte, error) {
	// We need to export the fields of Access but we don't want to make them public,
	// so we encode each field one by one.
...
// UnmarshalJSON returns an Access from a JSON encoding of it and its path name.
