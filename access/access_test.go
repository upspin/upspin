...
func (d *dummyUser) Dial(cc upspin.ClientContext, loc upspin.Location) (upspin.User, error) {
...
func (d *dummyStore) Dial(cc upspin.ClientContext, loc upspin.Location) (upspin.Store, error) {
...
func (d *dummyDirectory) Dial(cc upspin.ClientContext, loc upspin.Location) (upspin.Directory, error) {
