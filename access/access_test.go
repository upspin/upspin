...
func TestUsersAndCan(t *testing.T) {
	...
	checkUsers(a, Read, []string{"foo@foo.com", "bar@bar.com"})  // check that group owner is given same Read right as the group itself
	checkCan(a, "bar@bar.com", Read, "foo@foo.com/madeup", true) // check that group owner is given same Read right as the group itself

	checkUsers(a, Write, []string{"bar@bar.com"})                 // check that group owner is given same Write right as the group itself
	checkCan(a, "bar@bar.com", Write, "foo@foo.com/madeup", true) // check that group owner is given same Write right as the group itself
