...
func TestParseWrongFormat1(t *testing.T) {
	expectedErr := errors.E(upspin.PathName(testFile), errors.Invalid, errors.Str("1: invalid right: \"rrrr\""))
...
func TestParseWrongFormat4(t *testing.T) {
	expectedErr := errors.E(upspin.PathName(testFile), errors.Invalid, errors.Str(`1: invalid right: "rea"`))
