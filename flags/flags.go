...
// any extra flag names, and calls flag.Parse. Passing a nil default list
// registers all flags. Passing an unknown name triggers a panic.
// The Server and Client variables contain useful default sets.
//
// Examples:
// 	flags.Parse(flags.Client) // Register all client flags.
//	flags.ParseFlags(flags.Server, "cachedir") // Register all server flags plus cachedir.
