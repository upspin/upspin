...
var (
	...
	// LogLevel sets the level of logging: 0=Debug, 1=Info, 2=Error, 3=Disabled
	LogLevel = 1
)
...
func init() {
	...
	flag.IntVar(&LogLevel, "loglevel", LogLevel, "sets the level of logging: 0=Debug, 1=Info, 2=Error, 3=Disabled")
}
