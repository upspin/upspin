...
// Parse install the command-line flags for the given flag names
// and calls flag.Parse. Passing zero names installs all flags.
...
// Install registers the command-line flags for the given flag names
// and calls flag.Parse. Passing zero names install all flags.
// Passing an unknown name triggers a panic.
//
// For example:
// 	flags.Install("config", "endpoint") // Register Config and Endpoint.
// or
// 	flags.Install() // Register all flags.
