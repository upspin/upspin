...
You can run `upspinserver` on any server, as long as it has a
publicly-accessible IP address and can run Go programs (including Linux, MacOS,
Windows, and [more](https://golang.org/doc/install#requirements)).
...
You can privision a suitable Linux VM in your Google Cloud Project by visiting
the Compute section of the [Cloud Console](https://cloud.google.com/console)
and clicking "Create VM".

> If you're unfamiliar with cloud-based virtual machines, here are some sane
