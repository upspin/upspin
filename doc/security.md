...
This is an information leak scenario roughly equivalent to using PGP inside
...
Besides leaking metadata, a subverted Directory server can cause harm
...
Writing a file to a Store server leaks the creation time and the file size,
