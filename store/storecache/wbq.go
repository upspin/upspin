...
// request represents a request to write back a block. Each corresponds
...
func (wbq *writeBackQueue) isWriteBackFile(path string) bool {
	...
	wbq.request <- &request{upspin.Location{Reference: upspin.Reference(elems[2]), Endpoint: *e}, nil}
	return true
}
...
func (wbq *writeBackQueue) requestWriteBack(ref upspin.Reference, e upspin.Endpoint) error {
	...
	wbq.request <- &request{upspin.Location{Reference: ref, Endpoint: e}, nil}
	return nil
}
