...
type dirServer struct {
	...
	// TODO: all the fields below could be singletons.
...
func (d *dirServer) Configure(options ...string) error {
...
func (d *dirServer) isConfigured() bool {
...
func init() {
	bind.RegisterDirectory(upspin.GCP, newDirServer(nil, nil, nil, nil))
}
